...
import 'package:flutter_block_firebase_carapp/features/car/presentation/widgets/more_card.dart';


class CardDetailsPage extends StatefulWidget {
  final Car car;

  static route(Car car) => MaterialPageRoute(builder: (context) => CardDetailsPage(car: car));
...
class _CardDetailsPageState extends State<CardDetailsPage> with SingleTickerProviderStateMixin {
  ...
  @override
  void dispose() {
    _controller?.dispose(); // AnimationController'ı düzgün bir şekilde temizle
    super.dispose();
  }
              ...
              children: [
                ...
                Expanded(
                  child: GestureDetector(
                    onTap: () {
                      // Navigator.push to MapsDetailsPage gibi işlemler buraya eklenebilir
                    },
                    child: Container(
                      height: 170,
                      decoration: BoxDecoration(
